...
const MARKDOWN_COLORS = {
  HEADING: opaqueHex(alpha(PALETTE.CORAL, 0.9)),
  TEXT: opaqueHex(alpha(PALETTE.WHITE, 0.85)),
  TEXT_BOLD: opaqueHex(alpha(PALETTE.WHITE, 0.9)),
  TEXT_ITALIC: opaqueHex(alpha(PALETTE.WHITE, 0.85)),
  TEXT_STRIKETHROUGH: opaqueHex(alpha(PALETTE.WHITE, 0.6)),
  TEXT_CODE: "#F09483E6",
  ...
  PUNCTUATION_BOLD: opaqueHex(alpha(PALETTE.WHITE, 0.4)),
  PUNCTUATION_ITALIC: opaqueHex(alpha(PALETTE.WHITE, 0.4)),
  PUNCTUATION_STRIKETHROUGH: opaqueHex(alpha(PALETTE.WHITE, 0.4)),
  PUNCTUATION_HEADING: alpha(PALETTE.CORAL, 0.3),
